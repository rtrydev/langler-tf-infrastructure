...
for directory in global modules/api modules/auth modules/storage environments/prod; do
...
for directory in global modules/api modules/auth modules/frontend modules/storage; do
